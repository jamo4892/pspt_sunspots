"""
This script opens a PSPT red FITS image and plots two image views- 1 plot with a spectral
image color scale, and 1 plot with a gray color scale. The grayscale is the same color map as the JPG images that 
accompany each FITS image. Additionally, the grayscale image shows the 'window' that is used to mask out the sun 
before identifying the sunspots.
...
image = fits.open('./PSPTRedImages/FITS/20110103.1802.HW.R.P.rdc.fits.gz')
...
plt.savefig('./pspt_sunspots/red_image.png', bbox_inches = 'tight')
