"""
This script opens a PSPT calcium FITS image and plots two image views- 1 plot with a spectral
...
image = fits.open('./PSPTCalciumImages/FITS/20110103.1802.HW.K.P.rdc.fits.gz')
